...
from bciflow.datasets.mengu_raw import mengu_raw


# ==========================================================
# Test Suite: mengu_raw
# ==========================================================
#
# Cobertura:
...
#   8. Construção do raw contínuo
#   9. Construção de labels contínuos
#   10. Estrutura e integridade do dicionário retornado
#
# ==========================================================
...
class TestMenGuRaw:
    ...
    # ======================================================
    # SECTION 3 - Multiple Sessions Test
    # ======================================================
    ...
    # ======================================================
    # SECTION 6 - Continuous Label Alignment Test
    # ======================================================

    @patch("bciflow.datasets.h5py.File")
    def test_continuous_label_alignment(self, mock_h5py):
        ...
        assert eeg["X"].shape[1] == eeg["y"].shape[0]

    # ======================================================
    # SECTION 7 - Path Handling Test
    # ======================================================
